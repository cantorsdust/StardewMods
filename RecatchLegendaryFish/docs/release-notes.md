...
# Release notes
## Upcoming release
* Recatch Legendary Fish downloads are now created via [automated and attested builds](https://www.patreon.com/posts/automated-builds-148417912).  
...
* Fixed optional catch limit not applied correctly.
